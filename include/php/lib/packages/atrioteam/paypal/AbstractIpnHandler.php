...
/**
 * IPN Handler renamed to IPN_Handler_Abs.
 *
...
abstract class AbstractIpnHandler
{
        ...
        /**
         * Validates and sanItizes IPN data from PayPal.
         *
        ...
        protected static function validate(array $ipn_post_data)
        {
                ...
                (
                        ...
                        // @see https://stackoverflow.com/questions/25854207/access-denied-on-paypal-ipn-verification
                        CURLOPT_HTTPHEADER => array('Connection: Close', 'User-Agent: Acme')
                        //CURLOPT_CAINFO => 'cacert.pem', // certificazione !
                ));
