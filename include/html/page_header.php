...
?>
        <div id="page_header">
            ...
            <a id="buy_online"<?php echo count($arCartButtonClasses) > 0 ? ' class="'.implode(' ',$arCartButtonClasses).'"' : ''; ?> href="<?php $App->Lang->echoL('cart_index'); ?>">
...
-->                
                ...
                <ul id="pages_menu" class="reset">
                    ...
                    <li class="cart"><a<?php echo count($arCartButtonClasses) > 0 ? ' class="'.implode(' ',$arCartButtonClasses).'"' : ''; ?> href="<?php $App->Lang->echoL('cart_index'); ?>"><span><?php $App->Lang->echoT('nav_order_online'); ?></span></a></li>
                </ul>
