        ...
        <div id="page_header">
            ...
            <<?php echo $logo_tag; ?> id="logo">
                <a class="format_title mode1" href="<?php $App->Lang->echoL('homepage'); ?>">
                        <img 
                            src="/imgs/layout/<?php echo $App->Config['site']['code']; ?>-logo.svg" 
...
-->                
                ...
                <ul id="pages_menu" class="reset">
                    <li class="homepage"><a<?php echo $activeLinkKey == 'homepage' ? ' class="active"' : ''; ?> href="<?php $App->Lang->echoL('homepage'); ?>"><?php $App->Lang->echoT('home'); ?></a></li>
                    <li class="park"><a<?php echo $activeLinkKey == 'park' ? ' class="active"' : ''; ?> href="<?php $App->Lang->echoL('park'); ?>"><?php $App->Lang->echoT('nav_park'); ?></a></li>
                    <li class="tavern"><a<?php echo $activeLinkKey == 'tavern' ? ' class="active"' : ''; ?> href="<?php $App->Lang->echoL('tavern'); ?>"><?php $App->Lang->echoT('nav_tavern'); ?></a></li>
                    <li class="story"><a<?php echo $activeLinkKey == 'story' ? ' class="active"' : ''; ?> href="<?php $App->Lang->echoL('story'); ?>"><?php $App->Lang->echoT('nav_story'); ?></a></li>
                    <li class="hours_info"><a<?php echo $activeLinkKey == 'hours_info' ? ' class="active"' : ''; ?> href="<?php $App->Lang->echoL('hours_info'); ?>"><?php $App->Lang->echoT('nav_hours_info'); ?></a></li>
                    <!-- 
